...
export default function PolitiquesDeConfidentialite() {
  return (
    <Layout>
      ...
      >
        <h1 className="text-4xl text-center font-semibold mb-8 ">Politique de confidentialité</h1>
        <p>
          Le site web Car Web Distribution est détenu par Car Web Distribution,
        ...
        <p>
          ...
          manière dont nous traitons les informations collectées par Car Web
          Distribution, qui fournit également les raisons pour lesquelles nous
          ...
          d'utiliser le site web de Car Web Distribution.
        </p>
        <p>
          Nous prenons soin de vos données personnelles et nous nous engageons à
          en garantir la confidentialité et la sécurité.
        </p>
        <h4 className="text-lg font-semibold mb-2 mt-8">Les informations personnelles que nous collectons :</h4>
        <p>
          Lorsque vous visitez le Car Web Distribution, nous recueillons
        ...
        <h4 className="text-lg font-semibold mb-2 mt-8">Pourquoi traitons-nous vos données ?</h4>
        <p>
        ...
        <p>
          ...
          via info@carwebdistribution.ca.
        </p>
        <h4 className="text-lg font-semibold mb-2 mt-8">Vos droits :</h4>
        <p>
        ...
        <p>
          ...
          vos informations pourraient être transférées en dehors de l'Europe, y
          compris au Canada et aux États-Unis.
        </p>
        <h4 className="text-lg font-semibold mb-2 mt-8">Liens vers d'autres sites web :</h4>
        <p>
        ...
        <h4 className="text-lg font-semibold mb-2 mt-8">Sécurité de l'information :</h4>
        <p>
        ...
        <h4 className="text-lg font-semibold mb-2 mt-8">Divulgation légale :</h4>
        <p>
        ...
        <h4 className="text-lg font-semibold mb-2 mt-8">Informations de contact :</h4>
        <p>
