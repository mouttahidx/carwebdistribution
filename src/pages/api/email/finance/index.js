...
export default async function POST(req, res) {
  ...
  const mailOptions = {
    ...
    to: ["elmahdi.mouttahid@gmail.com",'info@carwebdistribution.ca'],
    // cc: email, (uncomment this line if you want to send a copy to the sender)
    subject: `Demande de financement: Carwebdistribution (${email})`,
    html: `
    <!doctype html>
<html lang="en">
  <head>
    ...
    <title>Car web distribution - Email</title>
        ...
        <td class="container">
          <div class="content">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  <p>Nouveau message du siteweb:</p>
                  </br>
                  </br>
