          ...
          <div className="flex gap-x-2 items-center">
            <div className="relative">
              ...
              <p
                ...
                className="hidden md:flex bg-rachel-red-700 text-white py-1.5 rounded-md px-1 lg:text-sm text-xs max-w-[120px] !whitespace-nowrap !text-ellipsis overflow-hidden cursor-pointer"
              >
                {localVehicle?.name}
              </p>
              <span
                ...
                className="text-xs whitespace-nowrap leading-3 text-center text-gray-400 block md:-mb-4 mt-1 absolute md:static -left-1 md:block hover:text-rachel-red-700 cursor-pointer overflow-hidden"
              >
                Filtrage
              </span>
            </div>
                ...
                <div className="mt-8 flex gap-2 flex-wrap">
                  {vehicles &&
                    vehicles.map((item) => (
                      ...
                      >
                        {item.subModel === "" && <p className="text-xs font-bold text-white">Piéces genériques de ce modéle</p>}
