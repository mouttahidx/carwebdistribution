...
export default function NewSlider() {
  ...
  return (
    <section className="bg-no-repeat bg-cover min-h-[400px] lg:min-h-[350px] relative -mt-5">
      ...
      <div className="w-full lg:px-10 px-2 h-[400px] lg:h-[350px] z-10 bg-black bg-opacity-25 rounded py-32 relative">
        <div className="flex flex-col justify-center h-full pt-10 ">
          ...
          <Link
            ...
            className="flex items-center bg-rachel-red-700 text-white xl:px-3 mx-auto rounded-md w-fit mt-4 mb-10 font-bold text-base px-6 py-2 "
            href={"/boutique"}
          >
            Magasiner
          </Link>
